            ...
            >
              <div className="cardHeader text-center">
                    ...
                    <div className="text-center mb-6">
                      <h2 className="text-xl text-blue-800 mb-0">CAN Care & Advancement Network</h2>
                      <p className="text-sm text-yellow-500 mb-3">Caring today, advancing tomorrow</p>
                      <h1 className="text-lg md:text-xl font-bold text-slate-900">Get Started - Registration</h1>
                    </div>
